# Saurabh's CareerCanvas - MERN Stack Job Portal
...
![Startup Website Screenshot](./Saurabh's CareerCanvas.gif)
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/yourusername/Saurabh's CareerCanvas-job-portal.git
   cd Saurabh's CareerCanvas-job-portal
