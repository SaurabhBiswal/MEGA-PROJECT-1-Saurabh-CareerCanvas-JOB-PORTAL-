      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
                <div className="lg:col-span-7">
                  <h2 className="font-bold text-4xl md:text-5xl bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent mb-4">
                    Join the Saurabh's CareerCanvas Community
                  </h2>
            ...
            <motion.div variants={itemVariants}>
              <div className="mb-6">
                <div className="flex items-center">
                  ...
                  <h3 className="text-2xl font-bold text-white">Saurabh's CareerCanvas</h3>
                </div>
        ...
        >
          <div className="flex items-center mb-4 md:mb-0">
            ...
            <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent font-bold text-xl">Saurabh's CareerCanvas</span>
          </div>
          
          <div className="text-sm text-gray-500">
            © 2025 Saurabh's CareerCanvas. All rights reserved.
          </div>
